...
object containeranalysis:
  ...
  type ContaineranalysisFunctions = com.pulumi.gcp.containeranalysis.ContaineranalysisFunctions
  object ContaineranalysisFunctions:
    // TODO [erasedDefinitions](https://github.com/lampepfl/dotty-feature-requests/issues/168#issuecomment-1486536624)
    export com.pulumi.gcp.containeranalysis.ContaineranalysisFunctions.*
  extension (self: ContaineranalysisFunctions.type)
    /** Retrieves the current IAM policy data for note */
    def getNoteIamPolicy(args: Endofunction[com.pulumi.gcp.containeranalysis.inputs.GetNoteIamPolicyArgs.Builder] = scala.Predef.identity):
    ...
    /** Retrieves the current IAM policy data for note */
    def getNoteIamPolicyPlain(args: Endofunction[com.pulumi.gcp.containeranalysis.inputs.GetNoteIamPolicyPlainArgs.Builder] = scala.Predef.identity):
