...
object databasemigrationservice:
  ...
  def ConnectionProfile(name: String, resourceOptions: Endofunction[CustomResourceOptions.Builder] = scala.Predef.identity)
      (args: Endofunction[com.pulumi.gcp.databasemigrationservice.ConnectionProfileArgs.Builder] = scala.Predef.identity)(using conf: KoPulumiConf) =
  ...
  def MigrationJob(name: String, resourceOptions: Endofunction[CustomResourceOptions.Builder] = scala.Predef.identity)
      (args: Endofunction[com.pulumi.gcp.databasemigrationservice.MigrationJobArgs.Builder] = scala.Predef.identity)(using conf: KoPulumiConf) =
  ...
  extension (builder: com.pulumi.gcp.databasemigrationservice.MigrationJobArgs.Builder)
     ...
     * @return builder
     */
    def postgresHomogeneousConfig(args: Endofunction[com.pulumi.gcp.databasemigrationservice.inputs.MigrationJobPostgresHomogeneousConfigArgs.Builder]):
        com.pulumi.gcp.databasemigrationservice.MigrationJobArgs.Builder =
      val argsBuilder = com.pulumi.gcp.databasemigrationservice.inputs.MigrationJobPostgresHomogeneousConfigArgs.builder
      builder.postgresHomogeneousConfig(args(argsBuilder).build)
  ...
  def PrivateConnection(name: String, resourceOptions: Endofunction[CustomResourceOptions.Builder] = scala.Predef.identity)
      (args: Endofunction[com.pulumi.gcp.databasemigrationservice.PrivateConnectionArgs.Builder] = scala.Predef.identity)(using conf: KoPulumiConf) =
  ...
  extension (builder: com.pulumi.gcp.databasemigrationservice.PrivateConnectionArgs.Builder)
     ...
     * @return builder
     */
    def pscInterfaceConfig(args: Endofunction[com.pulumi.gcp.databasemigrationservice.inputs.PrivateConnectionPscInterfaceConfigArgs.Builder]):
  ...
  extension (builder: com.pulumi.gcp.databasemigrationservice.inputs.ConnectionProfilePostgresqlArgs.Builder)
     ...
     * @return builder
     */
    def privateConnectivity(args: Endofunction[com.pulumi.gcp.databasemigrationservice.inputs.ConnectionProfilePostgresqlPrivateConnectivityArgs.Builder]):
        com.pulumi.gcp.databasemigrationservice.inputs.ConnectionProfilePostgresqlArgs.Builder =
      val argsBuilder = com.pulumi.gcp.databasemigrationservice.inputs.ConnectionProfilePostgresqlPrivateConnectivityArgs.builder
      builder.privateConnectivity(args(argsBuilder).build)
