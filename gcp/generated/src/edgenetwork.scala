...
object edgenetwork:
  ...
  def InterconnectAttachment(name: String, resourceOptions: Endofunction[CustomResourceOptions.Builder] = scala.Predef.identity)
      (args: Endofunction[com.pulumi.gcp.edgenetwork.InterconnectAttachmentArgs.Builder] = scala.Predef.identity)(using conf: KoPulumiConf) =
  ...
  def Network(name: String, resourceOptions: Endofunction[CustomResourceOptions.Builder] = scala.Predef.identity)
      (args: Endofunction[com.pulumi.gcp.edgenetwork.NetworkArgs.Builder] = scala.Predef.identity)(using conf: KoPulumiConf) =
  ...
  def Subnet(name: String, resourceOptions: Endofunction[CustomResourceOptions.Builder] = scala.Predef.identity)
      (args: Endofunction[com.pulumi.gcp.edgenetwork.SubnetArgs.Builder] = scala.Predef.identity)(using conf: KoPulumiConf) =
