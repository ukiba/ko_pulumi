...
object bigquerydatapolicy:
  type BigquerydatapolicyFunctions = com.pulumi.gcp.bigquerydatapolicy.BigquerydatapolicyFunctions
  object BigquerydatapolicyFunctions:
    // TODO [erasedDefinitions](https://github.com/lampepfl/dotty-feature-requests/issues/168#issuecomment-1486536624)
    export com.pulumi.gcp.bigquerydatapolicy.BigquerydatapolicyFunctions.*
  extension (self: BigquerydatapolicyFunctions.type)
    /** Retrieves the current IAM policy data for datapolicy */
    def getIamPolicy(args: Endofunction[com.pulumi.gcp.bigquerydatapolicy.inputs.GetIamPolicyArgs.Builder] = scala.Predef.identity):
    ...
    /** Retrieves the current IAM policy data for datapolicy */
    def getIamPolicyPlain(args: Endofunction[com.pulumi.gcp.bigquerydatapolicy.inputs.GetIamPolicyPlainArgs.Builder] = scala.Predef.identity):
