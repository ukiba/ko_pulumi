...
object mysql:
  ...
  def FlexibleDatabase(name: String, resourceOptions: Endofunction[CustomResourceOptions.Builder] = scala.Predef.identity)
      (args: Endofunction[com.pulumi.azure.mysql.FlexibleDatabaseArgs.Builder] = scala.Predef.identity)(using conf: KoPulumiConf) =
  ...
  def FlexibleServer(name: String, resourceOptions: Endofunction[CustomResourceOptions.Builder] = scala.Predef.identity)
      (args: Endofunction[com.pulumi.azure.mysql.FlexibleServerArgs.Builder] = scala.Predef.identity)(using conf: KoPulumiConf) =
  ...
  def FlexibleServerActiveDirectoryAdministratory(name: String, resourceOptions: Endofunction[CustomResourceOptions.Builder] = scala.Predef.identity)
      (args: Endofunction[com.pulumi.azure.mysql.FlexibleServerActiveDirectoryAdministratoryArgs.Builder] = scala.Predef.identity)(using conf: KoPulumiConf) =
  ...
  def FlexibleServerConfiguration(name: String, resourceOptions: Endofunction[CustomResourceOptions.Builder] = scala.Predef.identity)
      (args: Endofunction[com.pulumi.azure.mysql.FlexibleServerConfigurationArgs.Builder] = scala.Predef.identity)(using conf: KoPulumiConf) =
  ...
  def FlexibleServerFirewallRule(name: String, resourceOptions: Endofunction[CustomResourceOptions.Builder] = scala.Predef.identity)
      (args: Endofunction[com.pulumi.azure.mysql.FlexibleServerFirewallRuleArgs.Builder] = scala.Predef.identity)(using conf: KoPulumiConf) =
