...
object lighthouse:
  ...
  def Assignment(name: String, resourceOptions: Endofunction[CustomResourceOptions.Builder] = scala.Predef.identity)
      (args: Endofunction[com.pulumi.azure.lighthouse.AssignmentArgs.Builder] = scala.Predef.identity)(using conf: KoPulumiConf) =
  ...
  def Definition(name: String, resourceOptions: Endofunction[CustomResourceOptions.Builder] = scala.Predef.identity)
      (args: Endofunction[com.pulumi.azure.lighthouse.DefinitionArgs.Builder] = scala.Predef.identity)(using conf: KoPulumiConf) =
