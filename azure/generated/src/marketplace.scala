...
object marketplace:
  ...
  def Agreement(name: String, resourceOptions: Endofunction[CustomResourceOptions.Builder] = scala.Predef.identity)
      (args: Endofunction[com.pulumi.azure.marketplace.AgreementArgs.Builder] = scala.Predef.identity)(using conf: KoPulumiConf) =
  ...
  def RoleAssignment(name: String, resourceOptions: Endofunction[CustomResourceOptions.Builder] = scala.Predef.identity)
      (args: Endofunction[com.pulumi.azure.marketplace.RoleAssignmentArgs.Builder] = scala.Predef.identity)(using conf: KoPulumiConf) =
