...
object managedredis:
  ...
  def AccessPolicyAssignment(name: String, resourceOptions: Endofunction[CustomResourceOptions.Builder] = scala.Predef.identity)
      (args: Endofunction[com.pulumi.azure.managedredis.AccessPolicyAssignmentArgs.Builder] = scala.Predef.identity)(using conf: KoPulumiConf) =
  ...
  def GeoReplication(name: String, resourceOptions: Endofunction[CustomResourceOptions.Builder] = scala.Predef.identity)
      (args: Endofunction[com.pulumi.azure.managedredis.GeoReplicationArgs.Builder] = scala.Predef.identity)(using conf: KoPulumiConf) =
  ...
  def ManagedRedis(name: String, resourceOptions: Endofunction[CustomResourceOptions.Builder] = scala.Predef.identity)
      (args: Endofunction[com.pulumi.azure.managedredis.ManagedRedisArgs.Builder] = scala.Predef.identity)(using conf: KoPulumiConf) =
