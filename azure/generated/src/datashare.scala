...
object datashare:
  ...
  def Account(name: String, resourceOptions: Endofunction[CustomResourceOptions.Builder] = scala.Predef.identity)
      (args: Endofunction[com.pulumi.azure.datashare.AccountArgs.Builder] = scala.Predef.identity)(using conf: KoPulumiConf) =
  ...
  def DatasetBlobStorage(name: String, resourceOptions: Endofunction[CustomResourceOptions.Builder] = scala.Predef.identity)
      (args: Endofunction[com.pulumi.azure.datashare.DatasetBlobStorageArgs.Builder] = scala.Predef.identity)(using conf: KoPulumiConf) =
  ...
  def DatasetDataLakeGen2(name: String, resourceOptions: Endofunction[CustomResourceOptions.Builder] = scala.Predef.identity)
      (args: Endofunction[com.pulumi.azure.datashare.DatasetDataLakeGen2Args.Builder] = scala.Predef.identity)(using conf: KoPulumiConf) =
  ...
  def DatasetKustoCluster(name: String, resourceOptions: Endofunction[CustomResourceOptions.Builder] = scala.Predef.identity)
      (args: Endofunction[com.pulumi.azure.datashare.DatasetKustoClusterArgs.Builder] = scala.Predef.identity)(using conf: KoPulumiConf) =
  ...
  def DatasetKustoDatabase(name: String, resourceOptions: Endofunction[CustomResourceOptions.Builder] = scala.Predef.identity)
      (args: Endofunction[com.pulumi.azure.datashare.DatasetKustoDatabaseArgs.Builder] = scala.Predef.identity)(using conf: KoPulumiConf) =
  ...
  def Share(name: String, resourceOptions: Endofunction[CustomResourceOptions.Builder] = scala.Predef.identity)
      (args: Endofunction[com.pulumi.azure.datashare.ShareArgs.Builder] = scala.Predef.identity)(using conf: KoPulumiConf) =
