...
object dashboard:
  type DashboardFunctions = com.pulumi.azure.dashboard.DashboardFunctions
  object DashboardFunctions:
    // TODO [erasedDefinitions](https://github.com/lampepfl/dotty-feature-requests/issues/168#issuecomment-1486536624)
    export com.pulumi.azure.dashboard.DashboardFunctions.*
  extension (self: DashboardFunctions.type)
    ...
    @deprecated def azurerm_portal_dashboard(args: Endofunction[com.pulumi.azure.dashboard.inputs.Azurerm_portal_dashboardArgs.Builder] = scala.Predef.identity):
    ...
    /** Use this data source to access information about an existing shared dashboard in the Azure Portal. This is the data source of the `azurermDashboard` resource. */
    @deprecated def azurerm_portal_dashboardPlain(args: Endofunction[com.pulumi.azure.dashboard.inputs.Azurerm_portal_dashboardPlainArgs.Builder] = scala.Predef.identity):
    ...
    def getGrafana(args: Endofunction[com.pulumi.azure.dashboard.inputs.GetGrafanaArgs.Builder] = scala.Predef.identity):
    ...
    /** Use this data source to access information about an existing Grafana Dashboard. */
    def getGrafanaPlain(args: Endofunction[com.pulumi.azure.dashboard.inputs.GetGrafanaPlainArgs.Builder] = scala.Predef.identity):
