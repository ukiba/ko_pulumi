...
object dashboard:
  ...
  def Grafana(name: String, resourceOptions: Endofunction[CustomResourceOptions.Builder] = scala.Predef.identity)
      (args: Endofunction[com.pulumi.azure.dashboard.GrafanaArgs.Builder] = scala.Predef.identity)(using conf: KoPulumiConf) =
  ...
  def GrafanaManagedPrivateEndpoint(name: String, resourceOptions: Endofunction[CustomResourceOptions.Builder] = scala.Predef.identity)
      (args: Endofunction[com.pulumi.azure.dashboard.GrafanaManagedPrivateEndpointArgs.Builder] = scala.Predef.identity)(using conf: KoPulumiConf) =
