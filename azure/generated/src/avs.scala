...
object avs:
  ...
  def Cluster(name: String, resourceOptions: Endofunction[CustomResourceOptions.Builder] = scala.Predef.identity)
      (args: Endofunction[com.pulumi.azure.avs.ClusterArgs.Builder] = scala.Predef.identity)(using conf: KoPulumiConf) =
  ...
  def ExpressRouteAuthorization(name: String, resourceOptions: Endofunction[CustomResourceOptions.Builder] = scala.Predef.identity)
      (args: Endofunction[com.pulumi.azure.avs.ExpressRouteAuthorizationArgs.Builder] = scala.Predef.identity)(using conf: KoPulumiConf) =
  ...
  def NetappVolumeAttachment(name: String, resourceOptions: Endofunction[CustomResourceOptions.Builder] = scala.Predef.identity)
      (args: Endofunction[com.pulumi.azure.avs.NetappVolumeAttachmentArgs.Builder] = scala.Predef.identity)(using conf: KoPulumiConf) =
  ...
  def PrivateCloud(name: String, resourceOptions: Endofunction[CustomResourceOptions.Builder] = scala.Predef.identity)
      (args: Endofunction[com.pulumi.azure.avs.PrivateCloudArgs.Builder] = scala.Predef.identity)(using conf: KoPulumiConf) =
