...
object policy:
  ...
  def Definition(name: String, resourceOptions: Endofunction[CustomResourceOptions.Builder] = scala.Predef.identity)
      (args: Endofunction[com.pulumi.azure.policy.DefinitionArgs.Builder] = scala.Predef.identity)(using conf: KoPulumiConf) =
  ...
  def PolicySetDefinition(name: String, resourceOptions: Endofunction[CustomResourceOptions.Builder] = scala.Predef.identity)
      (args: Endofunction[com.pulumi.azure.policy.PolicySetDefinitionArgs.Builder] = scala.Predef.identity)(using conf: KoPulumiConf) =
  ...
  def VirtualMachineConfigurationAssignment(name: String, resourceOptions: Endofunction[CustomResourceOptions.Builder] = scala.Predef.identity)
      (args: Endofunction[com.pulumi.azure.policy.VirtualMachineConfigurationAssignmentArgs.Builder] = scala.Predef.identity)(using conf: KoPulumiConf) =
