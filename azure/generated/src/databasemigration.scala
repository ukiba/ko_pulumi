...
object databasemigration:
  ...
  def Project(name: String, resourceOptions: Endofunction[CustomResourceOptions.Builder] = scala.Predef.identity)
      (args: Endofunction[com.pulumi.azure.databasemigration.ProjectArgs.Builder] = scala.Predef.identity)(using conf: KoPulumiConf) =
  ...
  def Service(name: String, resourceOptions: Endofunction[CustomResourceOptions.Builder] = scala.Predef.identity)
      (args: Endofunction[com.pulumi.azure.databasemigration.ServiceArgs.Builder] = scala.Predef.identity)(using conf: KoPulumiConf) =
