...
object costmanagement:
  ...
  def AnomalyAlert(name: String, resourceOptions: Endofunction[CustomResourceOptions.Builder] = scala.Predef.identity)
      (args: Endofunction[com.pulumi.azure.costmanagement.AnomalyAlertArgs.Builder] = scala.Predef.identity)(using conf: KoPulumiConf) =
  ...
  def ScheduledAction(name: String, resourceOptions: Endofunction[CustomResourceOptions.Builder] = scala.Predef.identity)
      (args: Endofunction[com.pulumi.azure.costmanagement.ScheduledActionArgs.Builder] = scala.Predef.identity)(using conf: KoPulumiConf) =
