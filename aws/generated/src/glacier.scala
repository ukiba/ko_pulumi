...
object glacier:
  ...
  def Vault(name: String, resourceOptions: Endofunction[CustomResourceOptions.Builder] = scala.Predef.identity)
      (args: Endofunction[com.pulumi.aws.glacier.VaultArgs.Builder] = scala.Predef.identity)(using conf: KoPulumiConf) =
  ...
  def VaultLock(name: String, resourceOptions: Endofunction[CustomResourceOptions.Builder] = scala.Predef.identity)
      (args: Endofunction[com.pulumi.aws.glacier.VaultLockArgs.Builder] = scala.Predef.identity)(using conf: KoPulumiConf) =
