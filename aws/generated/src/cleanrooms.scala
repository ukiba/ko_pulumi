...
object cleanrooms:
  ...
  def Collaboration(name: String, resourceOptions: Endofunction[CustomResourceOptions.Builder] = scala.Predef.identity)
      (args: Endofunction[com.pulumi.aws.cleanrooms.CollaborationArgs.Builder] = scala.Predef.identity)(using conf: KoPulumiConf) =
  ...
  def ConfiguredTable(name: String, resourceOptions: Endofunction[CustomResourceOptions.Builder] = scala.Predef.identity)
      (args: Endofunction[com.pulumi.aws.cleanrooms.ConfiguredTableArgs.Builder] = scala.Predef.identity)(using conf: KoPulumiConf) =
  ...
  def Membership(name: String, resourceOptions: Endofunction[CustomResourceOptions.Builder] = scala.Predef.identity)
      (args: Endofunction[com.pulumi.aws.cleanrooms.MembershipArgs.Builder] = scala.Predef.identity)(using conf: KoPulumiConf) =
