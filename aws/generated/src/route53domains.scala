...
object route53domains:
  ...
  def DelegationSignerRecord(name: String, resourceOptions: Endofunction[CustomResourceOptions.Builder] = scala.Predef.identity)
      (args: Endofunction[com.pulumi.aws.route53domains.DelegationSignerRecordArgs.Builder] = scala.Predef.identity)(using conf: KoPulumiConf) =
  ...
  def Domain(name: String, resourceOptions: Endofunction[CustomResourceOptions.Builder] = scala.Predef.identity)
      (args: Endofunction[com.pulumi.aws.route53domains.DomainArgs.Builder] = scala.Predef.identity)(using conf: KoPulumiConf) =
  ...
  def RegisteredDomain(name: String, resourceOptions: Endofunction[CustomResourceOptions.Builder] = scala.Predef.identity)
      (args: Endofunction[com.pulumi.aws.route53domains.RegisteredDomainArgs.Builder] = scala.Predef.identity)(using conf: KoPulumiConf) =
