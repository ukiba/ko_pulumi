...
object licensemanager:
  ...
  def Association(name: String, resourceOptions: Endofunction[CustomResourceOptions.Builder] = scala.Predef.identity)
      (args: Endofunction[com.pulumi.aws.licensemanager.AssociationArgs.Builder] = scala.Predef.identity)(using conf: KoPulumiConf) =
   ...
   */
  def LicenseConfiguration(name: String, resourceOptions: Endofunction[CustomResourceOptions.Builder] = scala.Predef.identity)
      (args: Endofunction[com.pulumi.aws.licensemanager.LicenseConfigurationArgs.Builder] = scala.Predef.identity)(using conf: KoPulumiConf) =
  ...
  def LicenseGrant(name: String, resourceOptions: Endofunction[CustomResourceOptions.Builder] = scala.Predef.identity)
      (args: Endofunction[com.pulumi.aws.licensemanager.LicenseGrantArgs.Builder] = scala.Predef.identity)(using conf: KoPulumiConf) =
  ...
  def LicenseGrantAccepter(name: String, resourceOptions: Endofunction[CustomResourceOptions.Builder] = scala.Predef.identity)
      (args: Endofunction[com.pulumi.aws.licensemanager.LicenseGrantAccepterArgs.Builder] = scala.Predef.identity)(using conf: KoPulumiConf) =
