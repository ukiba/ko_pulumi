...
object servicediscovery:
  ...
  def HttpNamespace(name: String, resourceOptions: Endofunction[CustomResourceOptions.Builder] = scala.Predef.identity)
      (args: Endofunction[com.pulumi.aws.servicediscovery.HttpNamespaceArgs.Builder] = scala.Predef.identity)(using conf: KoPulumiConf) =
  ...
  def Instance(name: String, resourceOptions: Endofunction[CustomResourceOptions.Builder] = scala.Predef.identity)
      (args: Endofunction[com.pulumi.aws.servicediscovery.InstanceArgs.Builder] = scala.Predef.identity)(using conf: KoPulumiConf) =
  ...
  def PrivateDnsNamespace(name: String, resourceOptions: Endofunction[CustomResourceOptions.Builder] = scala.Predef.identity)
      (args: Endofunction[com.pulumi.aws.servicediscovery.PrivateDnsNamespaceArgs.Builder] = scala.Predef.identity)(using conf: KoPulumiConf) =
  ...
  def PublicDnsNamespace(name: String, resourceOptions: Endofunction[CustomResourceOptions.Builder] = scala.Predef.identity)
      (args: Endofunction[com.pulumi.aws.servicediscovery.PublicDnsNamespaceArgs.Builder] = scala.Predef.identity)(using conf: KoPulumiConf) =
  ...
  def Service(name: String, resourceOptions: Endofunction[CustomResourceOptions.Builder] = scala.Predef.identity)
      (args: Endofunction[com.pulumi.aws.servicediscovery.ServiceArgs.Builder] = scala.Predef.identity)(using conf: KoPulumiConf) =
