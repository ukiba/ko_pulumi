...
object outposts:
  ...
  extension (self: OutpostsFunctions.type)
    ...
    def getAsset(args: Endofunction[com.pulumi.aws.outposts.inputs.GetAssetArgs.Builder] = scala.Predef.identity):
    ...
    /** Information about a specific hardware asset in an Outpost. */
    def getAssetPlain(args: Endofunction[com.pulumi.aws.outposts.inputs.GetAssetPlainArgs.Builder] = scala.Predef.identity):
    ...
    def getAssets(args: Endofunction[com.pulumi.aws.outposts.inputs.GetAssetsArgs.Builder] = scala.Predef.identity):
    ...
    /** Information about hardware assets in an Outpost. */
    def getAssetsPlain(args: Endofunction[com.pulumi.aws.outposts.inputs.GetAssetsPlainArgs.Builder] = scala.Predef.identity):
    ...
    def getOutpost(args: Endofunction[com.pulumi.aws.outposts.inputs.GetOutpostArgs.Builder] = scala.Predef.identity):
    ...
    /** Provides details about an Outposts Outpost. */
    def getOutpostPlain(args: Endofunction[com.pulumi.aws.outposts.inputs.GetOutpostPlainArgs.Builder] = scala.Predef.identity):
    ...
    def getOutpostInstanceType(args: Endofunction[com.pulumi.aws.outposts.inputs.GetOutpostInstanceTypeArgs.Builder] = scala.Predef.identity):
    ...
    /** Information about single Outpost Instance Type. */
    def getOutpostInstanceTypePlain(args: Endofunction[com.pulumi.aws.outposts.inputs.GetOutpostInstanceTypePlainArgs.Builder] = scala.Predef.identity):
    ...
    def getOutpostInstanceTypes(args: Endofunction[com.pulumi.aws.outposts.inputs.GetOutpostInstanceTypesArgs.Builder] = scala.Predef.identity):
    ...
    /** Information about Outposts Instance Types. */
    def getOutpostInstanceTypesPlain(args: Endofunction[com.pulumi.aws.outposts.inputs.GetOutpostInstanceTypesPlainArgs.Builder] = scala.Predef.identity):
    ...
    def getOutposts(args: Endofunction[com.pulumi.aws.outposts.inputs.GetOutpostsArgs.Builder] = scala.Predef.identity):
    ...
    /** Provides details about multiple Outposts. */
    def getOutpostsPlain(args: Endofunction[com.pulumi.aws.outposts.inputs.GetOutpostsPlainArgs.Builder] = scala.Predef.identity):
    ...
    def getSite(args: Endofunction[com.pulumi.aws.outposts.inputs.GetSiteArgs.Builder] = scala.Predef.identity):
    ...
    /** Provides details about an Outposts Site. */
    def getSitePlain(args: Endofunction[com.pulumi.aws.outposts.inputs.GetSitePlainArgs.Builder] = scala.Predef.identity):
    ...
    def getSites(args: Endofunction[com.pulumi.aws.outposts.inputs.GetSitesArgs.Builder] = scala.Predef.identity):
    ...
    /** Provides details about multiple Outposts Sites. */
    def getSitesPlain(args: Endofunction[com.pulumi.aws.outposts.inputs.GetSitesPlainArgs.Builder] = scala.Predef.identity):
