...
object aws:
  ...
  extension (self: AwsFunctions.type)
    ...
    def getArn(args: Endofunction[com.pulumi.aws.inputs.GetArnArgs.Builder] = scala.Predef.identity):
    ...
    /** Parses an ARN into its constituent parts. */
    def getArnPlain(args: Endofunction[com.pulumi.aws.inputs.GetArnPlainArgs.Builder] = scala.Predef.identity):
     ...
     */
    def getAvailabilityZone(args: Endofunction[com.pulumi.aws.inputs.GetAvailabilityZoneArgs.Builder] = scala.Predef.identity):
     ...
     *  which provides a list of the available zones.
     */
    def getAvailabilityZonePlain(args: Endofunction[com.pulumi.aws.inputs.GetAvailabilityZonePlainArgs.Builder] = scala.Predef.identity):
     ...
     */
    def getAvailabilityZones(args: Endofunction[com.pulumi.aws.inputs.GetAvailabilityZonesArgs.Builder] = scala.Predef.identity):
     ...
     *  &gt; When [Local Zones](https://aws.amazon.com/about-aws/global-infrastructure/localzones/) are enabled in a region, by default the API and this data source include both Local Zones and Availability Zones. To return only Availability Zones, see the example section below.
     */
    def getAvailabilityZonesPlain(args: Endofunction[com.pulumi.aws.inputs.GetAvailabilityZonesPlainArgs.Builder] = scala.Predef.identity):
    ...
    def getBillingServiceAccount(args: Endofunction[com.pulumi.aws.inputs.GetBillingServiceAccountArgs.Builder] = scala.Predef.identity):
    ...
    /** Use this data source to get the Account ID of the [AWS Billing and Cost Management Service Account](http://docs.aws.amazon.com/awsaccountbilling/latest/aboutv2/billing-getting-started.html#step-2) for the purpose of permitting in S3 bucket policy. */
    def getBillingServiceAccountPlain(args: Endofunction[com.pulumi.aws.inputs.GetBillingServiceAccountPlainArgs.Builder] = scala.Predef.identity):
     ...
     */
    def getCallerIdentity(args: Endofunction[com.pulumi.aws.inputs.GetCallerIdentityArgs.Builder] = scala.Predef.identity):
     ...
     *  which this provider is authorized.
     */
    def getCallerIdentityPlain(args: Endofunction[com.pulumi.aws.inputs.GetCallerIdentityPlainArgs.Builder] = scala.Predef.identity):
     ...
     */
    def getDefaultTags(args: Endofunction[com.pulumi.aws.inputs.GetDefaultTagsArgs.Builder] = scala.Predef.identity):
     ...
     *  With this data source, you can apply default tags to resources not _directly_ managed by a resource, such as the instances underneath an Auto Scaling group or the volumes created for an EC2 instance.
     */
    def getDefaultTagsPlain(args: Endofunction[com.pulumi.aws.inputs.GetDefaultTagsPlainArgs.Builder] = scala.Predef.identity):
    ...
    def getIpRanges(args: Endofunction[com.pulumi.aws.inputs.GetIpRangesArgs.Builder] = scala.Predef.identity):
    ...
    /** Use this data source to get the IP ranges of various AWS products and services. For more information about the contents of this data source and required JSON syntax if referencing a custom URL, see the [AWS IP Address Ranges documentation](https://docs.aws.amazon.com/general/latest/gr/aws-ip-ranges.html). */
    def getIpRangesPlain(args: Endofunction[com.pulumi.aws.inputs.GetIpRangesPlainArgs.Builder] = scala.Predef.identity):
     ...
     */
    def getPartition(args: Endofunction[com.pulumi.aws.inputs.GetPartitionArgs.Builder] = scala.Predef.identity):
     ...
     *  which the provider is working.
     */
    def getPartitionPlain(args: Endofunction[com.pulumi.aws.inputs.GetPartitionPlainArgs.Builder] = scala.Predef.identity):
     ...
     */
    def getRegion(args: Endofunction[com.pulumi.aws.inputs.GetRegionArgs.Builder] = scala.Predef.identity):
     ...
     *  configuration from its parent module.
     */
    def getRegionPlain(args: Endofunction[com.pulumi.aws.inputs.GetRegionPlainArgs.Builder] = scala.Predef.identity):
    ...
    def getRegions(args: Endofunction[com.pulumi.aws.inputs.GetRegionsArgs.Builder] = scala.Predef.identity):
    ...
    /** Provides information about AWS Regions. Can be used to filter regions i.e., by Opt-In status or only regions enabled for current account. To get details like endpoint and description of each region the data source can be combined with the `aws.getRegion` data source. */
    def getRegionsPlain(args: Endofunction[com.pulumi.aws.inputs.GetRegionsPlainArgs.Builder] = scala.Predef.identity):
    ...
    def getService(args: Endofunction[com.pulumi.aws.inputs.GetServiceArgs.Builder] = scala.Predef.identity):
    ...
    /** Use this data source to compose and decompose AWS service DNS names. */
    def getServicePlain(args: Endofunction[com.pulumi.aws.inputs.GetServicePlainArgs.Builder] = scala.Predef.identity):
    ...
    def getServicePrincipal(args: Endofunction[com.pulumi.aws.inputs.GetServicePrincipalArgs.Builder] = scala.Predef.identity):
    ...
    /** Use this data source to create a Service Principal Name for a service in a given region. Service Principal Names should always end in the standard global format: `{servicename}.amazonaws.com`. However, in some AWS partitions, AWS may expect a different format. */
    def getServicePrincipalPlain(args: Endofunction[com.pulumi.aws.inputs.GetServicePrincipalPlainArgs.Builder] = scala.Predef.identity):
