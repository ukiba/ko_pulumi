...
object sqs:
  ...
  def Queue(name: String, resourceOptions: Endofunction[CustomResourceOptions.Builder] = scala.Predef.identity)
      (args: Endofunction[com.pulumi.aws.sqs.QueueArgs.Builder] = scala.Predef.identity)(using conf: KoPulumiConf) =
  ...
  def QueuePolicy(name: String, resourceOptions: Endofunction[CustomResourceOptions.Builder] = scala.Predef.identity)
      (args: Endofunction[com.pulumi.aws.sqs.QueuePolicyArgs.Builder] = scala.Predef.identity)(using conf: KoPulumiConf) =
  ...
  def RedriveAllowPolicy(name: String, resourceOptions: Endofunction[CustomResourceOptions.Builder] = scala.Predef.identity)
      (args: Endofunction[com.pulumi.aws.sqs.RedriveAllowPolicyArgs.Builder] = scala.Predef.identity)(using conf: KoPulumiConf) =
  ...
  def RedrivePolicy(name: String, resourceOptions: Endofunction[CustomResourceOptions.Builder] = scala.Predef.identity)
      (args: Endofunction[com.pulumi.aws.sqs.RedrivePolicyArgs.Builder] = scala.Predef.identity)(using conf: KoPulumiConf) =
