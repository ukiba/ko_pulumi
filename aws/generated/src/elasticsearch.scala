...
object elasticsearch:
  ...
  def Domain(name: String, resourceOptions: Endofunction[CustomResourceOptions.Builder] = scala.Predef.identity)
      (args: Endofunction[com.pulumi.aws.elasticsearch.DomainArgs.Builder] = scala.Predef.identity)(using conf: KoPulumiConf) =
  ...
  def DomainPolicy(name: String, resourceOptions: Endofunction[CustomResourceOptions.Builder] = scala.Predef.identity)
      (args: Endofunction[com.pulumi.aws.elasticsearch.DomainPolicyArgs.Builder] = scala.Predef.identity)(using conf: KoPulumiConf) =
  ...
  def DomainSamlOptions(name: String, resourceOptions: Endofunction[CustomResourceOptions.Builder] = scala.Predef.identity)
      (args: Endofunction[com.pulumi.aws.elasticsearch.DomainSamlOptionsArgs.Builder] = scala.Predef.identity)(using conf: KoPulumiConf) =
  ...
  def VpcEndpoint(name: String, resourceOptions: Endofunction[CustomResourceOptions.Builder] = scala.Predef.identity)
      (args: Endofunction[com.pulumi.aws.elasticsearch.VpcEndpointArgs.Builder] = scala.Predef.identity)(using conf: KoPulumiConf) =
