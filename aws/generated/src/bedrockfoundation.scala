...
object bedrockfoundation:
  ...
  extension (self: BedrockfoundationFunctions.type)
    ...
    def getModel(args: Endofunction[com.pulumi.aws.bedrockfoundation.inputs.GetModelArgs.Builder] = scala.Predef.identity):
    ...
    /** Data source for managing an AWS Bedrock Foundation Model. */
    def getModelPlain(args: Endofunction[com.pulumi.aws.bedrockfoundation.inputs.GetModelPlainArgs.Builder] = scala.Predef.identity):
    ...
    def getModels(args: Endofunction[com.pulumi.aws.bedrockfoundation.inputs.GetModelsArgs.Builder] = scala.Predef.identity):
    ...
    /** Data source for managing AWS Bedrock Foundation Models. */
    def getModelsPlain(args: Endofunction[com.pulumi.aws.bedrockfoundation.inputs.GetModelsPlainArgs.Builder] = scala.Predef.identity):
