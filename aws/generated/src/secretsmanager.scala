...
object secretsmanager:
  ...
  def Secret(name: String, resourceOptions: Endofunction[CustomResourceOptions.Builder] = scala.Predef.identity)
      (args: Endofunction[com.pulumi.aws.secretsmanager.SecretArgs.Builder] = scala.Predef.identity)(using conf: KoPulumiConf) =
  ...
  def SecretPolicy(name: String, resourceOptions: Endofunction[CustomResourceOptions.Builder] = scala.Predef.identity)
      (args: Endofunction[com.pulumi.aws.secretsmanager.SecretPolicyArgs.Builder] = scala.Predef.identity)(using conf: KoPulumiConf) =
  ...
  def SecretRotation(name: String, resourceOptions: Endofunction[CustomResourceOptions.Builder] = scala.Predef.identity)
      (args: Endofunction[com.pulumi.aws.secretsmanager.SecretRotationArgs.Builder] = scala.Predef.identity)(using conf: KoPulumiConf) =
  ...
  def SecretVersion(name: String, resourceOptions: Endofunction[CustomResourceOptions.Builder] = scala.Predef.identity)
      (args: Endofunction[com.pulumi.aws.secretsmanager.SecretVersionArgs.Builder] = scala.Predef.identity)(using conf: KoPulumiConf) =
  ...
  def Tag(name: String, resourceOptions: Endofunction[CustomResourceOptions.Builder] = scala.Predef.identity)
      (args: Endofunction[com.pulumi.aws.secretsmanager.TagArgs.Builder] = scala.Predef.identity)(using conf: KoPulumiConf) =
