...
object keyspaces:
  ...
  def Keyspace(name: String, resourceOptions: Endofunction[CustomResourceOptions.Builder] = scala.Predef.identity)
      (args: Endofunction[com.pulumi.aws.keyspaces.KeyspaceArgs.Builder] = scala.Predef.identity)(using conf: KoPulumiConf) =
  ...
  def Table(name: String, resourceOptions: Endofunction[CustomResourceOptions.Builder] = scala.Predef.identity)
      (args: Endofunction[com.pulumi.aws.keyspaces.TableArgs.Builder] = scala.Predef.identity)(using conf: KoPulumiConf) =
