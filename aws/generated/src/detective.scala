...
object detective:
  ...
  def Graph(name: String, resourceOptions: Endofunction[CustomResourceOptions.Builder] = scala.Predef.identity)
      (args: Endofunction[com.pulumi.aws.detective.GraphArgs.Builder] = scala.Predef.identity)(using conf: KoPulumiConf) =
  ...
  def InvitationAccepter(name: String, resourceOptions: Endofunction[CustomResourceOptions.Builder] = scala.Predef.identity)
      (args: Endofunction[com.pulumi.aws.detective.InvitationAccepterArgs.Builder] = scala.Predef.identity)(using conf: KoPulumiConf) =
  ...
  def Member(name: String, resourceOptions: Endofunction[CustomResourceOptions.Builder] = scala.Predef.identity)
      (args: Endofunction[com.pulumi.aws.detective.MemberArgs.Builder] = scala.Predef.identity)(using conf: KoPulumiConf) =
  ...
  def OrganizationAdminAccount(name: String, resourceOptions: Endofunction[CustomResourceOptions.Builder] = scala.Predef.identity)
      (args: Endofunction[com.pulumi.aws.detective.OrganizationAdminAccountArgs.Builder] = scala.Predef.identity)(using conf: KoPulumiConf) =
  ...
  def OrganizationConfiguration(name: String, resourceOptions: Endofunction[CustomResourceOptions.Builder] = scala.Predef.identity)
      (args: Endofunction[com.pulumi.aws.detective.OrganizationConfigurationArgs.Builder] = scala.Predef.identity)(using conf: KoPulumiConf) =
