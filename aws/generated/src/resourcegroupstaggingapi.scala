...
object resourcegroupstaggingapi:
  ...
  extension (self: ResourcegroupstaggingapiFunctions.type)
    ...
    def getRequiredTags(args: Endofunction[com.pulumi.aws.resourcegroupstaggingapi.inputs.GetRequiredTagsArgs.Builder] = scala.Predef.identity):
    ...
    /** Lists the required tags for supported resource types in an AWS account. Required tags are defined through AWS Organizations [tag policies](https://docs.aws.amazon.com/organizations/latest/userguide/orgs_manage_policies_tag-policies.html). */
    def getRequiredTagsPlain(args: Endofunction[com.pulumi.aws.resourcegroupstaggingapi.inputs.GetRequiredTagsPlainArgs.Builder] = scala.Predef.identity):
    ...
    def getResources(args: Endofunction[com.pulumi.aws.resourcegroupstaggingapi.inputs.GetResourcesArgs.Builder] = scala.Predef.identity):
    ...
    /** Provides details about resource tagging. */
    def getResourcesPlain(args: Endofunction[com.pulumi.aws.resourcegroupstaggingapi.inputs.GetResourcesPlainArgs.Builder] = scala.Predef.identity):
