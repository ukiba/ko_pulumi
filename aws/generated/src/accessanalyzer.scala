...
object accessanalyzer:
  ...
  def Analyzer(name: String, resourceOptions: Endofunction[CustomResourceOptions.Builder] = scala.Predef.identity)
      (args: Endofunction[com.pulumi.aws.accessanalyzer.AnalyzerArgs.Builder] = scala.Predef.identity)(using conf: KoPulumiConf) =
  ...
  def ArchiveRule(name: String, resourceOptions: Endofunction[CustomResourceOptions.Builder] = scala.Predef.identity)
      (args: Endofunction[com.pulumi.aws.accessanalyzer.ArchiveRuleArgs.Builder] = scala.Predef.identity)(using conf: KoPulumiConf) =
