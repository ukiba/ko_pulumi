...
object fms:
  ...
  def AdminAccount(name: String, resourceOptions: Endofunction[CustomResourceOptions.Builder] = scala.Predef.identity)
      (args: Endofunction[com.pulumi.aws.fms.AdminAccountArgs.Builder] = scala.Predef.identity)(using conf: KoPulumiConf) =
  ...
  def Policy(name: String, resourceOptions: Endofunction[CustomResourceOptions.Builder] = scala.Predef.identity)
      (args: Endofunction[com.pulumi.aws.fms.PolicyArgs.Builder] = scala.Predef.identity)(using conf: KoPulumiConf) =
  ...
  def ResourceSet(name: String, resourceOptions: Endofunction[CustomResourceOptions.Builder] = scala.Predef.identity)
      (args: Endofunction[com.pulumi.aws.fms.ResourceSetArgs.Builder] = scala.Predef.identity)(using conf: KoPulumiConf) =
